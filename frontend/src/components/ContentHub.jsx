      ...
      <div className="max-w-7xl mx-auto px-6 py-20">
        ...
        <div className="mb-10">
          ...
          <div className="flex flex-wrap gap-6 mt-6 text-sm text-gray-600">
            ...
            <span className="cursor-pointer hover:text-black">Guidelines</span>
        ...
        <div className="flex justify-center gap-4 mt-12">
          <button className="bg-gray-800 text-white px-5 py-2">← Prev</button>
          <button className="bg-gray-800 text-white px-5 py-2">Next →</button>
        </div>
      </div>
    </section>
  );
